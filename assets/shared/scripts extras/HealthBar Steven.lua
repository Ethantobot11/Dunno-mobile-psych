function onCreate()
makeAnimatedLuaSprite('uglyHB','healthbar/iconbar2',0,0);
scaleObject('uglyHB', 2.9, 2.9);
luaSpriteAddAnimationByPrefix('uglyHB', 'pouco', 'Icons Bar', 24, true);
luaSpriteAddAnimationByPrefix('uglyHB', 'medio', 'Icons Bar', 24, true);
luaSpriteAddAnimationByPrefix('uglyHB', 'cheio', 'Icons Bar', 24, true);
...
setProperty('healthBarBG.visible', false);
    ...
    setProperty('uglyHB.x', getProperty('healthBar.x') - 355)
    setProperty('uglyHB.angle', getProperty('healthBar.angle'))
    setProperty('uglyHB.y', getProperty('healthBar.y')  - 100)
...
function onUpdatePost()
    setProperty('iconP1.x', 710)
    setProperty('iconP1.y', 600)
    setProperty('iconP2.x', 410)
    setProperty('iconP2.y', 590)
    if downscroll then 
    setProperty('iconP2.y', 45)
    end
end

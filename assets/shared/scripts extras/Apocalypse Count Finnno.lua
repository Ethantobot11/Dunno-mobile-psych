...
makeAnimatedLuaSprite('bf', 'BF_Pibby_Introno', 800, 800)
...
makeAnimatedLuaSprite('pibby', 'Pibby_Introno', 800, 800)
...
setProperty('bf.x', (getProperty('boyfriend.x')+50))
setProperty('bf.y', (getProperty('boyfriend.y')+15))
setObjectOrder('bf',getObjectOrder('boyfriendGroup')+1)
else
setProperty('bf.x', (getProperty('boyfriend.x')-200))
...
if boyfriendName == 'newbf2' then
setProperty('bf.x', (getProperty('boyfriend.x')-20))
setProperty('bf.y', (getProperty('boyfriend.y')-100))
else
setProperty('bf.x', (getProperty('boyfriend.x')-270))
...
if boyfriendName == 'newbf2' then
setProperty('bf.x', (getProperty('boyfriend.x')-20))
setProperty('bf.y', (getProperty('boyfriend.y')+30))
else
setProperty('bf.x', (getProperty('boyfriend.x')-270))
...
if foca then
triggerEvent('Camera Follow Pos', 1250, 2000)
end 
end
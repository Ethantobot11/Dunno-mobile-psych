...
if songName == 'suffering-siblings-v3' then
jake2=true
pibby2=true
end
end
...
setProperty('OPPO2.x', getProperty('healthBar.x') -160)
setProperty('OPPO2.y', getProperty('healthBar.y') -80)
setProperty('OPP2.x', getProperty('healthBar.x') - 160)
setProperty('OPP2.y', getProperty('healthBar.y') -80)
setProperty('PBY2.x', getProperty('healthBar.x') +620)
setProperty('PBY2.y', getProperty('healthBar.y') -70)
setProperty('PBYL2.x', getProperty('healthBar.x') +620)
setProperty('PBYL2.y', getProperty('healthBar.y') -70)
setProperty('PBY.x', getProperty('healthBar.x') +270)
setProperty('PBY.y', getProperty('healthBar.y') -70)
setProperty('PBYL.x', getProperty('healthBar.x') +270)
setProperty('PBYL.y', getProperty('healthBar.y') -70)
...
function onBeatHit()
setProperty('PBY2.scale.x', 0.8)
setProperty('PBY2.scale.y', 0.8)
setProperty('PBYL2.scale.x', 0.8)
setProperty('PBYL2.scale.y', 0.8)
setProperty('OPPO2.scale.x', 0.8)
setProperty('OPPO2.scale.y', 0.8)
setProperty('OPP2.scale.x', 0.8)
setProperty('OPP2.scale.y', 0.8)
doTweenX('ICONX', 'PBY2.scale', 0.6, 1, 'circOut')
doTweenY('ICONY', 'PBY2.scale', 0.6, 1, 'circOut')
doTweenX('ICONX2', 'PBYL2.scale', 0.6, 1, 'circOut')
doTweenY('ICONY2', 'PBYL2.scale', 0.6, 1, 'circOut')
doTweenX('ICONX22', 'OPPO2.scale', 0.6, 1, 'circOut')
doTweenY('ICONY22', 'OPPO2.scale', 0.6, 1, 'circOut')
doTweenX('ICONX221', 'OPP2.scale', 0.6, 1, 'circOut')
doTweenY('ICONY221', 'OPP2.scale', 0.6, 1, 'circOut')
end

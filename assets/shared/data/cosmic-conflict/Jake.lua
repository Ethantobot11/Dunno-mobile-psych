...
name_of_character_xml = 'Corr_rigby'
--tên của nhân vật(do bạn tạo)/ name of character(is your custom)
name_of_character = 'Corr_rigby'
...
setProperty('Corr_rigby.x', (getProperty('dad.x')+100))
setProperty('Corr_rigby.y', (getProperty('dad.y')+0))
setObjectOrder('Jake',getObjectOrder('dadGroup')-1)
runTimer('IdleChar',0.15)
holdTimers = -1;
end

function onCreate()
if songName == "Child's Play" or songName == 'Retcon' then 
...
addLuaScript('scripts extras/Shaders/glitchy notes by ansfoxy')
addLuaScript('scripts extras/Shaders/Glitchy icon') 
addLuaScript('scripts extras/Shaders/TvGumball') 
end
end
...
if songName == 'Suffering Siblings' or songName == 'Suffering Siblings V3' then
addLuaScript('scripts extras/HealthBar Finn') 
addLuaScript('scripts extras/Apocalypse Count Finn')
...
addLuaScript('scripts extras/Shaders/glitchy notes by ansfoxy')
--addLuaScript('scripts extras/Shaders/Glitchy icon') 
addLuaScript('scripts extras/Shaders/Glitchy icon2') 
end
end

if songName == "Come Along With Me" then 
if getPropertyFromClass('ClientPrefs', 'shaders') == true then
addLuaScript('scripts extras/Shaders/Reveal shader')
addLuaScript('scripts extras/Shaders/Finn glitchy')
addLuaScript('scripts extras/Shaders/glitchy notes by ansfoxy')
end
end
